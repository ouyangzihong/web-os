  ...
  <section class="why-section">
    ...
    <div class="col col-split" ref="col0">
      <div class="split-cell">
        <img :src="images[0]" alt="project-05-01" class="col-img" />
      </div>
      <div class="split-cell">
        <img :src="images[1]" alt="project-05-02" class="col-img" />
      </div>
    </div>
    ...
    <div class="col col-split" ref="col1">
      <div class="split-cell">
        <img :src="images[2]" alt="project-05-03" class="col-img" />
      </div>
      <div class="split-cell">
        <img :src="images[3]" alt="project-05-04" class="col-img" />
      </div>
    </div>

    <!-- 第三列：大图 + 文字 -->
    <div class="col col-main" ref="col2">
      <img :src="images[4]" alt="project-05-05" class="col-img" />
