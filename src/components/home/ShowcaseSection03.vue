<template>
  <section class="showcase-section-03">
    <!-- 第一列：大图 -->
    ...
    <div class="col col-split" ref="col1">
      <div class="split-cell">
        <img :src="images[1]" alt="showcase-03-02" class="col-img" />
      </div>
      <div class="split-cell">
        <img :src="images[2]" alt="showcase-03-03" class="col-img" />
      </div>
    </div>
    ...
    <div class="col col-split" ref="col2">
      <div class="split-cell">
        <img :src="images[3]" alt="showcase-03-04" class="col-img" />
      </div>
      <div class="split-cell">
        <img :src="images[4]" alt="showcase-03-05" class="col-img" />
      </div>
    </div>
  </section>
</template>
...
import img01 from '@/assets/images/home/Home006-01.webp';
import img02 from '@/assets/images/home/Home006-02.webp';
import img03 from '@/assets/images/home/Home006-03.webp';
import img04 from '@/assets/images/home/Home006-04.webp';
import img05 from '@/assets/images/home/Home006-05.webp';
